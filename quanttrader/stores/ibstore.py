...
from ..dataseries import TimeFrame, Position
from .metabase import MetaParams
from ..utils.py3 import bytes, bstr, queue, with_metaclass, long
from ..utils import AutoDict, UTC
...
class IBStore(with_metaclass(MetaSingleton, object)):
    ...
    Params:
      ...
      - ``timeoffset`` (default: ``True``)
        ...
        The time offset will propagate to other parts of the ``quanttrader``
