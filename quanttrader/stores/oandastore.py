...
class OandaStore(with_metaclass(MetaSingleton, object)):
    ...
    def __init__(self):
        ...
        self.notifs = collections.deque()  # store notifications for engine

        self._env = None  # reference to engine for general notifications
    ...
    _GRANULARITIES = {
        (trader.TimeFrame.Seconds, 5): 'S5',
        (trader.TimeFrame.Seconds, 10): 'S10',
        (trader.TimeFrame.Seconds, 15): 'S15',
        (trader.TimeFrame.Seconds, 30): 'S30',
        (trader.TimeFrame.Minutes, 1): 'M1',
        (trader.TimeFrame.Minutes, 2): 'M3',
        (trader.TimeFrame.Minutes, 3): 'M3',
        (trader.TimeFrame.Minutes, 4): 'M4',
        (trader.TimeFrame.Minutes, 5): 'M5',
        (trader.TimeFrame.Minutes, 10): 'M5',
        (trader.TimeFrame.Minutes, 15): 'M5',
        (trader.TimeFrame.Minutes, 30): 'M5',
        (trader.TimeFrame.Minutes, 60): 'H1',
        (trader.TimeFrame.Minutes, 120): 'H2',
        (trader.TimeFrame.Minutes, 180): 'H3',
        (trader.TimeFrame.Minutes, 240): 'H4',
        (trader.TimeFrame.Minutes, 360): 'H6',
        (trader.TimeFrame.Minutes, 480): 'H8',
        (trader.TimeFrame.Days, 1): 'D',
        (trader.TimeFrame.Weeks, 1): 'W',
        (trader.TimeFrame.Months, 1): 'M',
    }
    ...
    _ORDEREXECS = {
        trader.Order.Market: 'market',
        trader.Order.Limit: 'limit',
        trader.Order.Stop: 'stop',
        trader.Order.StopLimit: 'stop',
    }
    ...
    def order_create(self, order, stopside=None, takeside=None, **kwargs):
        ...
        if order.exectype != trader.Order.Market:
    ...
    def _t_order_create(self):
        while True:
            ...
            for oid in oids:
                self._ordersrev[oid] = oref  # maps ids to quanttrader order
