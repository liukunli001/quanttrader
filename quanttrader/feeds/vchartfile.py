...
from .. import date2num  # avoid dict lookups


class MetaVChartFile(trader.DataBase.__class__):
    def __init__(cls, name, bases, dct):
        ...
        trader.stores.VChartFile.DataCls = cls


class VChartFile(trader.with_metaclass(MetaVChartFile, trader.DataBase)):
    '''
