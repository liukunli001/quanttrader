...
class MetaRollOver(trader.DataBase.__class__):
...
class RollOver(trader.with_metaclass(MetaRollOver, trader.DataBase)):
    ...
    def _gettz(self):
        ...
        return trader.utils.date.Localizer(self.p.tz)
