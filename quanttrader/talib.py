...
try:
    ...
    class _MetaTALibIndicator(trader.Indicator.__class__):
        _refname = '_taindcol'
        _taindcol = dict()
        ...
        def dopostinit(cls, _obj, *args, **kwargs):
            ...
            engine = trader.metabase.findowner(_obj, trader.Engine)
    ...
    class _TALibIndicator(with_metaclass(_MetaTALibIndicator, trader.Indicator)):
